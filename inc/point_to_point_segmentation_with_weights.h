...
class PointToPointSegmentationWithWeights : public PointToPointSegmentation
{
public:
	PointToPointSegmentationWithWeights(int model_size, int model_dim, int num_segments, int batch_size, int max_num_neighbors, double beta, double sigma);
